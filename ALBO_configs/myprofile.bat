...
@set db.user.flextera.name=AK_FLEXTERA7
@set db.user.flextera.password=AK_FLEXTERA7
...
@set config.flextera.emplPort=9082
@set config.flextera.clHost=localhost
@set config.flextera.clPort=9082
...
@set config.albo.cryptoproPassword=111111
...
@set config.albo.rqws.resultFolderPath=D:/albo/dev/RequestFiles
